...
int LI;
    ...
    if(LI == 2){
        ...
        if(HA == 2){
            int SA;
            printf("You want to watch some:\n1-Super Heroes\n2-Realistic Adventures\n");
            printf("Option:");
            scanf("%d", &SA);

            if(SA == 1){
                printf("If you want to watch some Sup.Heroes, I'd recomend you to wacth Vingadores Ultimato!");
            }
            if(SA == 2){
                printf("If you want to watch some Rea.Adventures, I'd recomend you to wacth Mad Max!");
            }
        }
